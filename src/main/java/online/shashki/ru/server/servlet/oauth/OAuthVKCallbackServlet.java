package online.shashki.ru.server.servlet.oauth;
...
import online.shashki.ru.server.config.OAuthClient;
import online.shashki.ru.server.config.ServerConfiguration;
