 ...
 * 	/Users/alekspo/Documents/Development/GWT/draughts/default/rusdraughts/client/src/main/java/online/draughts/rus/shared/locale/DraughtsMessages.properties'.
 */
public interface DraughtsMessages extends com.google.gwt.i18n.client.Messages {
  ...
  /**
   * Translated "doAboutUs".
   * 
   * @return translated "doAboutUs"
   */
  @DefaultMessage("doAboutUs")
  @Key("aboutUsToken")
  String aboutUsToken();

  /**
   * Translated "You already connected".
   * 
   * @return translated "You already connected"
   */
  @DefaultMessage("You already connected")
  ...
  /**
   * Translated "Chose color:".
   * 
   * @return translated "Chose color:"
   */
  @DefaultMessage("Chose color:")
  @Key("chooseYourColor")
   ...
   * Translated "Draughts".
   * 
   * @return translated "Draughts"
   */
  @DefaultMessage("Draughts")
  @Key("draughts")
  String draughts();
  ...
  /**
   * Translated "Game not found".
   * 
   * @return translated "Game not found"
   */
  ...
  /**
   * Translated "Forbidden characters".
   * 
   * @return translated "Forbidden characters"
   */
  @DefaultMessage("Forbidden characters")
  @Key("invalidCharsInName")
  String invalidCharsInName();

  /**
   * Translated "Invite".
   * 
   * @return translated "Invite"
   */
   ...
   * Translated "New game".
   * 
   * @return translated "New game"
   */
  @DefaultMessage("New game")
  @Key("newGameButtonText")
  String newGameButtonText();

  /**
   * Translated "New message <i>{0}</i>".
   * 
   * @return translated "New message <i>{0}</i>"
   */
  @DefaultMessage("New message <i>{0}</i>")
  @Key("newMessageFrom")
  String newMessageFrom(String arg0);
   ...
   * Translated "Notation".
   * 
   * @return translated "Notation"
   */
  @DefaultMessage("Notation")
  @Key("notationTitle")
  ...
  /**
   * Translated "Opponent not found".
   * 
   * @return translated "Opponent not found"
   */
  @DefaultMessage("Opponent not found")
  ...
  /**
   * Translated "Game list".
   * 
   * @return translated "Game list"
   */
  @DefaultMessage("Game list")
  @Key("playListButtonText")
   ...
   * Translated "doPlay".
   * 
   * @return translated "doPlay"
   */
  @DefaultMessage("doPlay")
  @Key("playToken")
  String playToken();
  ...
  /**
   * Translated "Player offline".
   * 
   * @return translated "Player offline"
   */
  @DefaultMessage("Player offline")
  @Key("playerOffline")
  ...
  /**
   * Translated "doProfile".
   * 
   * @return translated "doProfile"
   */
  @DefaultMessage("doProfile")
  @Key("profileToken")
  String profileToken();
  ...
  /**
   * Translated "doSettings".
   * 
   * @return translated "doSettings"
   */
  @DefaultMessage("doSettings")
  @Key("settingsToken")
   ...
   * 
   * @return translated "Waiting response."
   */
  ...
  /**
   * Translated "<span style=\"color:green;\">Your turn</span>".
   * 
   * @return translated "<span style=\"color:green;\">Your turn</span>"
   */
